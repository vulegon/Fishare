...
ActiveRecord::Schema[7.0].define(version: 2024_09_28_132541) do
  ...
  create_table "user_roleships", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "user_role_id"], name: "index_user_roleships_on_user_id_and_user_role_id", unique: true
